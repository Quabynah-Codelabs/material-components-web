      ...
      <tr class="mdc-data-table__header-row">
        ...
        >
          <div class="mdc-data-table__header-cell-wrapper">
            ...
            <div class="mdc-data-table__visually-hidden-label" aria-hidden="true" data-sort-status-label id="dessert-status-label">
            </div>
          </div>
        </th>
        <th
        ...
        >
          <div class="mdc-data-table__header-cell-wrapper">
            ...
            <div class="mdc-data-table__visually-hidden-label" aria-hidden="true" data-sort-status-label id="carbs-status-label"></div>
          </div>
        </th>
        <th
        ...
        >
          <div class="mdc-data-table__header-cell-wrapper">
            ...
            <div class="mdc-data-table__visually-hidden-label" aria-hidden="true" data-sort-status-label id="protein-status-label"></div>
          </div>
        </th>
        <th
...
`mdc-data-table__visually-hidden-label` | Optional. Class name added to visually hidden element. Only visible to screen reader users.
